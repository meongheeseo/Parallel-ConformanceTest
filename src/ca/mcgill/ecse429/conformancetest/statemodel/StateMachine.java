...
public class StateMachine {
	...
	public String toString() {
		String outputString = "";
		return super.toString() + "[" + "packageName" + ":" + getPackageName() + "," + "className" + ":"
				+ getClassName() + "]" + System.getProperties().getProperty("line.separator") + "  " + "startState"
				+ "="
				+ (getStartState() != null
						? !getStartState().equals(this) ? getStartState().toString().replaceAll("  ", "    ") : "this"
						: "null")
				+ outputString;
	}
}